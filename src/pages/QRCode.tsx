      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white p-6">
        <div className="max-w-2xl mx-auto space-y-6">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">QR Code WhatsApp</h1>
            <p className="text-gray-600 text-lg">Conecte sua sessão do WhatsApp</p>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">QR Code WhatsApp</h1>
          <p className="text-gray-600 text-lg">Conecte sua sessão do WhatsApp para <strong>{currentCompany.name}</strong></p>
        </div>
